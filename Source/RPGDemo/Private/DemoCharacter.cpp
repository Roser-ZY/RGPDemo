...
ADemoCharacter::ADemoCharacter()
{
    ...
    spring_arm_component_ = CreateDefaultSubobject<USpringArmComponent>("Spring Arm");
    ...
    camera_component_ = CreateDefaultSubobject<UCameraComponent>("Camera");
...
void ADemoCharacter::BeginPlay()
{
    ...
    if (player_controller)
    {
        ...
        if (subsystem)
        {
            subsystem->AddMappingContext(movement_input_context_, 0);
        }
    }
}
